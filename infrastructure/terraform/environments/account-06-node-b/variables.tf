...
# Networking Ranges (Internal Routing)
...
# Fixed Private IPs (Security Groups White-listing)
...
# AWS Account IDs (Static Identifiers)
...
# Target VPC Discovery (Managed by Data Sources in main.tf)
# No default values to ensure 100% automated discovery
